...
const LLMEngineerPage = () => {
  // Transform the llmEngineer data into the format expected by CourseModuleCard
  const courseModules = llmEngineer.sections.map((section) => ({
    title: section.title,
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                {llmEngineer.sections.length} Comprehensive Sections
              </p>
            </div>
          </div>
        </motion.div>
