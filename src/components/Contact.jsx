        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              ...
              Feel free to reach out to me. I'm always open to new challenges
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="p-2 rounded-full bg-white text-gray-700 hover:bg-primary-50 hover:text-primary-600 transition-colors"
