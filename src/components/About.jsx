...
const BentoCard = ({ Icon, title, children, className = "", delay = 0 }) => {
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-xl p-5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg transition-all ${className}`}
      whileHover={{ y: -3 }}
