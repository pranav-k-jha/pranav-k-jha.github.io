        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">
              I'm an AI Engineer with a passion for building intelligent systems
              that solve real-world problems. I specialize in Machine Learning,
              Deep Learning, and Computer Vision, with experience in developing
              and deploying AI models in production environments.
            </p>
