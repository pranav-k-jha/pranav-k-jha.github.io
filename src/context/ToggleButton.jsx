...
const ThemeToggle = () => {
  ...
  return (
    <div className="inline-block overflow-hidden rounded-full">
      <motion.button
        onClick={toggleTheme}
        className={`theme-toggle-button relative flex items-center w-16 h-8 rounded-full p-1 m-0
      ...
      >
        ...
        <motion.div
          ...
          className={`relative z-10 w-6 h-6 rounded-full flex items-center justify-center shadow-md m-0
          ${
            isLight ? "bg-white text-yellow-500" : "bg-gray-900 text-blue-400"
          }`}
          animate={{
            x: isLight ? 0 : 32, // ✅ Correct - perfectly symmetric spacing
          }}
        >
