...
`).forEach(o=>{const s=o.indexOf(":");if(s>-1){const c=o.slice(0,s).trim();let t=o.slice(s+1).trim();(t.startsWith('"')&&t.endsWith('"')||t.startsWith("'")&&t.endsWith("'"))&&(t=t.slice(1,-1)),a[c]=t}}),{data:a,content:r}}const g=Object.assign({"./posts/building-bridges-ai-research.md":d,"./posts/genai-and-agentic-ai.md":m,"./posts/scaling-heights-ml-training.md":p,"./posts/urban-analytics.md":u}),l=Object.entries(g).map(([n,e])=>{const i=n.split("/").pop().replace(/\.md$/,""),{data:r,content:a}=h(e);return{slug:i,...r,content:a}}).sort((n,e)=>new Date(e.date)-new Date(n.date));function f(){return l.map(({content:n,...e})=>e)}function y(n){return l.find(e=>e.slug===n)||null}export{y as a,f as g};
