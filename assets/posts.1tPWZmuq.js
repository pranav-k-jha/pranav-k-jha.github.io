const t={"getting-started-with-ml":{id:1,title:"Getting Started with Machine Learning",excerpt:"Learn the basics of machine learning and how to get started with your first project.",date:"2025-10-31",category:"Machine Learning",readTime:"2 min read",author:"Pranav K Jha",authorTitle:"AI Engineer",authorAvatar:"/profile.jpeg",content:`
...
\`\`\`
    `},"introduction-to-deep-learning":{id:2,title:"Introduction to Deep Learning",excerpt:"A comprehensive introduction to deep learning concepts and applications.",date:"2025-11-01",category:"Deep Learning",readTime:"1 min read",author:"Pranav K Jha",authorTitle:"AI Engineer",authorAvatar:"/profile.jpeg",content:`
...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
\`\`\`
    `},"cursor-vs-cloud-code":{id:3,title:"Cursor vs Cloud Code: A Detailed Comparison for Developers",excerpt:"A comprehensive comparison between Cursor AI and Google Cloud Code for developers.",date:"2025-11-02",category:"Development Tools",readTime:"2 min read",author:"Pranav K Jha",authorTitle:"AI Engineer",authorAvatar:"/profile.jpeg",content:`
...
Both tools are valuable but serve different purposes in the development workflow. Cursor enhances coding efficiency with AI, while Cloud Code simplifies cloud deployments and debugging.
    `}},o=()=>Object.entries(t).map(([e,a])=>({slug:e,...a,content:void 0})),r=e=>t[e]||null;export{r as a,o as g};
