...
\`\`\`
    `},"introduction-to-deep-learning":{id:2,title:"Introduction to Deep Learning",excerpt:"A comprehensive introduction to deep learning concepts and applications.",date:"2025-11-01",category:"Deep Learning",readTime:"8 min read",author:"Pranav K Jha",authorTitle:"AI Engineer",authorAvatar:"/profile.jpeg",content:`
...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
\`\`\`
    `}},n=()=>Object.entries(t).map(([e,a])=>({slug:e,...a,content:void 0})),i=e=>t[e]||null;export{i as a,n as g};
